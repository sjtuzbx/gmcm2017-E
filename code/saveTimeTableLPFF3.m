function time_table = saveTimeTableLPFF3(edge_id, path_id, length, velocity, stagePoint, x_f, dt)
    numOfVar = zeros(24, 1);
    znode = zeros(24, 2);
    for i=1:24
    ...
    for i=1:24
       ...
       t = x_f(st);
       info = [letter,int2str(i),':',int2label(path_id{i}(1+stagePoint(i,1))),' ',num2str(t+dt)];
